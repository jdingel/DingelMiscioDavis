...
geo_calc <- function(shapefile,
  ...
  cat(paste0("In year 2001 definitions, the median sub-district had a land area of ",
  ...
  if (details==T) {
    ...
    cat(paste0("In year 2001 definitions, the 5$^{\\text{th}}$, 50$^{\\text{th}}$, and 95$^{\\text{th}}$ percentiles of sub-district land area were ",
